...
$query = "SELECT * FROM board $where ORDER BY id DESC LIMIT $no, $page_size ";
...
<title> The Board for Performance n Go for it </title>
<style>
<!--
td {font-size : 9pt;}
...
?>
   ...
   <form method=post action='list.php'>
    <tr>
        <td width=100% height="70" colspan=5 align=center>
...
<BR>
<body>
<FONT COLOR="#A0A0A0">Jung Wi Dae</FONT><BR><BR>
</body>
</center>
</body>
</html>